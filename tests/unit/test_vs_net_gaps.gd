...
func test_a_pawn_sync_speaks_for_its_owner() -> void:
	...
	assert_true(pawn_sync.replication_config.has_property(NodePath(":sync_xform")))
	assert_false(pawn_sync.replication_config.has_property(NodePath(":position")))
	assert_false(pawn_sync.replication_config.has_property(NodePath(":rotation")))
...
func test_zombie_and_cart_sync_carry_the_look_flags() -> void:
	...
	assert_true(cart_sync.replication_config.has_property(NodePath(":sync_xform")))
	assert_false(cart_sync.replication_config.has_property(NodePath(":position")))
	assert_false(cart_sync.replication_config.has_property(NodePath(":rotation")))
	...
	assert_true(mech_sync.replication_config.has_property(NodePath(":sync_xform")))
	assert_true(mech_sync.replication_config.has_property(NodePath(":sync_stick")))
	...
	assert_true(girl_sync.replication_config.has_property(NodePath(":sync_xform")))
	assert_false(girl_sync.replication_config.has_property(NodePath(":position")))
	assert_false(girl_sync.replication_config.has_property(NodePath(":rotation")))
	...
	var ball_sync := NetSync.attach_ball(ball)
	assert_true(ball_sync.replication_config.has_property(NodePath(":sync_xform")))
	assert_true(ball_sync.replication_config.has_property(NodePath(":linear_velocity")))
	assert_false(ball_sync.replication_config.has_property(NodePath(":position")))
	assert_false(ball_sync.replication_config.has_property(NodePath(":rotation")))
...
func test_apply_mech_moves_the_grouped_suit() -> void:
	var world := _world_fx()
...
func test_apply_mech_plants_a_suit_when_none_exists() -> void:
	...
	var found := MechSuit.find_net(get_tree(), 7)
	assert_not_null(found)
	assert_eq(found.owner_peer, 7)
	assert_true(found.closed)
	found.queue_free()
