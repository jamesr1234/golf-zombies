...
const CUES := {
	...
	"remote_fire": [1, 880.0, 220.0, 0.1, 0.24],
	...
	"slide": [2, 90.0, 40.0, 0.16, 0.22],
	"glide_open": [0, 180.0, 720.0, 0.18, 0.26],
	"glide_cut": [0, 520.0, 160.0, 0.12, 0.22],
	...
	"mine_drop": [1, 160.0, 70.0, 0.12, 0.28],
	...
	"brake": [1, 190.0, 48.0, 0.2, 0.34],
	"crush": [2, 80.0, 40.0, 0.18, 0.38],
	"boost_pad": [0, 160.0, 880.0, 0.2, 0.26],
	"escalator_reverse": [1, 220.0, 880.0, 0.14, 0.22],
	"steps_fold": [1, 420.0, 110.0, 0.28, 0.26],
	"steps_unfold": [1, 110.0, 420.0, 0.28, 0.24],
	"cooler_open": [0, 320.0, 170.0, 0.16, 0.2],
	"buy_beer": [0, 660.0, 880.0, 0.14, 0.22],
	"place_barrier": [0, 220.0, 640.0, 0.2, 0.26],
	"place_ladder": [0, 180.0, 520.0, 0.16, 0.24],
	"throw_ladder": [2, 360.0, 90.0, 0.22, 0.32],
	"grapple_fire": [3, 720.0, 180.0, 0.16, 0.3],
	"grapple_latch": [1, 420.0, 180.0, 0.14, 0.34],
	"grapple_release": [0, 280.0, 140.0, 0.1, 0.22],
	"zipline_grab": [1, 380.0, 720.0, 0.14, 0.26],
	"zipline_drop": [0, 260.0, 120.0, 0.1, 0.2],
	...
	"elevator_bell": [0, 880.0, 1320.0, 0.16, 0.2],
